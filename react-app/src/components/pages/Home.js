          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                ...
                fully decoupled applications. What is the meaning of the
                decoupled in this context you may ask? Well, decoupled refers to
                a separation between the back-end and front-end. In this sense
                Drupal is used as a back-end to store your content and provide
                API to your front-end applications. This means that you can
                connect your website, mobile application and anything you want
                to a single back-end.
              </Card.Text>
              <Card.Text>
